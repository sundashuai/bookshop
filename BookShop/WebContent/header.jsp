	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/BookShop/default.jsp">首页</a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<form class="navbar-form navbar-right" role="search" action="${pageContext.request.contextPath}/product?method=productInfo&pid=d4450501-14f1-43dd-82d0-784751d94b67" method="post">
				...
				<script type="text/javascript">
					...
					function searchWord(obj){
						...
						var content = "";
						$.post(
							"${pageContext.request.contextPath}/searchWorld",
							{"word":word},
							function(data){
