	...
	<div class="container">
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 350px; height: 400px;" title=""
						class="medium"
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div style="margin: 10px 0 10px 0;">
						参考价: <strong style="color: #ef0101;">￥：${product.shop_price}元/份</strong> 市场价：
					...
					<div
						...
						<div style="margin: 5px 0 10px 0;">出版日期：${product.pdate}</div>
			...
			<div style="width: 950px; margin: 0 auto;">
				...
				<div>
					<div style="width:400px;height:400px;float:left">
						<img style="opacity: 1; width: 350px; height: 400px;" src="${pageContext.request.contextPath }/${product.pimage}">
					</div>
					<div style="width:500px;height:350px;float:left;text-align:left" id="div1">
